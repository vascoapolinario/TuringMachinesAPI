...
import { LayoutDashboard, Users, Box, Server, LogOut, Menu, X, Terminal as TerminalIcon, PlayCircle, ShieldAlert, UserCircle, ScrollText } from 'lucide-react';
...
const Sidebar = ({ onOpenTerminal }: { onOpenTerminal: () => void }) => {
  ...
  const navItems = [
    ...
    { path: '/leaderboard', icon: Trophy, label: 'Leaderboard' }, // Need Trophy import if not present, checking imports...
...
export default App;
import { Trophy } from 'lucide-react'; // Added explicit Trophy import for Leaderboard icon
